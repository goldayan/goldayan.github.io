...
*** TODO Network isolation in homelab
- Guest wifi
- Two router
...
*** TODO Emacs custom identation
*** TODO My pixel phone display fault experience
- Esim issue
- ADB and wireless adb to resuce with scrcpy
- Backuping up data, default usb mode selection in developer option
- Caffinate - always on display
- Lesson learnt
