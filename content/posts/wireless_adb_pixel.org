...
On the Google Pixel 9 (running Android 14 or 15), there is **no single
default port** for wireless debugging. Instead, the port number is
**randomized** every time you enable the feature or reboot the device.
